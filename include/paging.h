...
#define phys_addr_from_pte(pte)         ((pte) & 0xFFFFF000)    
#define phys_addr_4mb_from_pde(pde)     ((pde) & 0xFFC00000)     
#define phys_addr_4kb_from_pde(pde)     ((pde) & 0xFFFFF000)
#define pfn_from_phys_addr(p_addr)      ((p_addr) >> 12)
#define phys_addr_from_pfn(pfn)      	((pfn) << 12)
#define pfn_from_pte(pte)               (phys_addr_from_pte(pte) >> 12)    
